...
| **Ticket Tracker** | P2 | 0.1.0 | `modules/ticket-tracker/` | `index.ts` | `createTicketRoutes(store)`, `createJsonFileStore(filePath)`, `validateCreatePayload`, `nextTicketId` + types (`Ticket`, `TicketStore`) |
